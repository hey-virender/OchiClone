...
function Navbar() {
  ...
  return (
    <div
      className={`fixed z-[999] w-full px-20 py-8 font-['Neue Montreal'] flex justify-between items-center transition-all duration-300 bg-zinc-900 ${
    ...
    >
      ...
      <div className="links flex gap-10">
        {["Sevices", "Our Work", "About Us", "Insights", "Contact"].map(
          (item, index) => (
            <a
              key={index}
              className={`capitalize text-md font-light ${
                index === 4 && "ml-32"
              }`}
            >
              {item}
