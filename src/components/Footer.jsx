...
function Footer() {
  return (
    <div className="w-full bg-zinc-900 p-20 flex font-['Founders Grotesk']">
      <div className="w-2/5 h-[90vh] flex flex-col justify-between  ">
        <div className="heading">
          <h1 className="text-[7vw] uppercase leading-none font-bold -mb-[1.5vw] tracking-tighter">
            Eye-
          </h1>
          <h1 className="text-[7vw] uppercase leading-none font-bold -mb-[1.5vw] tracking-tighter">
            opening
      ...
      <div className="w-3/5">
        ...
        <div className="links w-full flex jusify-between">
          <div className="left w-1/2">
            <div className="dets mt-10 ml-4">
              ...
              <div className="location flex flex-col mt-10 gap-3">
              ...
              <div className="email flex flex-col mt-10 gap-3">
                <span className="mb-1">E:</span>
                <span className="underline">hello@ochi.design</span>
              </div>
            </div>
          </div>
          <div className="right w-1/2 flex justify-end items-end">
            <div className="menu flex flex-col mb-[5vw]">
              <span>M:</span>
              {[
                "Home",
                "Services",
